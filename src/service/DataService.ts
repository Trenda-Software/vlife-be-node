...
export default class DataService {
    ...
    async initDBData() {
        ...
        const user1 = await UserModel.create({ dni: 24111222, name: 'Javier', surname: 'Hack', pwd: 'javi1234', email: 'javierhack@gmail.com', mobile: '1122101000' });
        ...
        const practice1 = await PracticeModel.create({ name: 'Cambio de Bolsa de colosiomia', code: 'CBC', cost: '600', aditional_info: true });
        const practice2 = await PracticeModel.create({ name: 'Inyeccion Intramuscular', code: 'IIM', cost: '300', aditional_info: true });
        const practice3 = await PracticeModel.create({ name: 'Higiene de Paciente', code: 'HIP', cost: '200', aditional_info: false });
